$(function () {
    $("#side-menu>li:eq(2)").addClass("active").find("ul").addClass("in").find("li:eq(1)").addClass("active");
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (key, value) {
                var cate = $("<li class=\"list-group-item\" data-uniqueid=\"" + value.UniqueId + "\" data-catename=\"" + value.CateName + "\" data-alias=\"" + value.Alias + "\" data-img=\"" + value.Img + "\" data-link=\"" + value.Link + "\">"
                    + "<div class=\"row\">"
                    + "<div class=\"col-md-2\">"
                    + "<i class=\"fa fa-arrows\"></i> "
                    + "<span class=\"fileinput-button\">"
...
function bindFileUpload() {
    $(".fileupload").fileupload({
        ...
        dataType: "text",
            ...
            $(this).prev().attr("src", data.result);
            $(this).parent().parent().parent().parent().data("img", data.result);
        }
    });
}
