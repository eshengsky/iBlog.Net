...
!function ($) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                $.each(data, function (key, value) {
                                    if (value.Link == "") {
                                        addOptionToSelectControl(selectControl, value.Alias, value.CateName);
                                    }
                                });
                                addOptionToSelectControl(selectControl, "other", "未分类");
                            }
                        });
                        break;
                    case 'var':
    ...
    BootstrapTable.prototype.initSearch = function () {
        ...
        var that = this;
        var fp = null;//$.isEmptyObject(this.filterColumnsPartial) ? null : this.filterColumnsPartial;
